...
public class XfyunConfig {
    ...
    public static String buildCollaborationPrompt(String contextSummary) {
        return """
                ...
                ## 创作指导：
                1. **背景整合**：基于场景设计师的场景设定和氛围设计师的环境描述，构建完整的故事背景
                2. **角色发展**：以角色设计师设计的角色为基础，结合团队讨论，丰富角色的动机、关系和剧本内容
                3. **线索布局**：将线索设计师的线索与场景、角色有机结合，确保每条线索都有明确的发现方式和推理价值
                4. **氛围营造**：利用氛围设计师的环境要素（灯光、音乐、天气等）增强剧本的沉浸感
                5. **逻辑链条**：根据节点间的连接关系，构建清晰的因果关系和推理路径
                6. **团队智慧**：将聊天讨论中的创意想法和建议融入剧本，体现协作价值
